            ...
            <form method="post" id="productForm" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">إضافة نوع قطعة   </h4>
                    </div>
                    <div class="modal-body">


                        <label>    تحديد المادة   </label>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var table = $('#tableData').DataTable({
                ...
                ajax: "{{ route('peices_type.get_materials', $type->id) }}",
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $.get("{{ route('peices_type.get_materials', $type->id) }}" + '/' + product_id + '/raw', function (data) {
                    ...
                    $('#raw_id').val(data.raw_material_id);
            ...
            $('#action').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('peices_type.raws.store', $type->id) }}",
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('peices_type.get_materials', $type->id) }}" + '/' + product_id,
