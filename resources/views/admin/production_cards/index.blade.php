    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var table = $('#tableData').DataTable({
                ...
                ajax: "{{ route('production_cards.index') }}",
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $.get("{{ route('production_cards.index') }}" + '/' + product_id + '/edit', function (data) {
            ...
            $('#action').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('production_cards.store') }}",
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('production_cards.store') }}" + '/' + product_id,
