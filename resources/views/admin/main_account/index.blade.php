        ...
        <section class="content-header">
            ...
            <h6  style="text-align:right;direction: rtl;"   >
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">الحسابات الرئيسية   </a></li>
                            ...
                            <div class="table-responsive">
                                ...
                                <div align="right">
                                    <button type="button" id="createNewProduct"
                                            data-toggle="modal" data-target="#advertModal" class="btn btn-info btn-lg">إضافة</button>
                                </div>
                                <br /><br />
                                <table id="tableData" class="table table-bordered table-striped" dir="rtl">
                                    ...
                                    <tr>
                                        ...
                                        <th width="5%"> #</th>
                                        <th width="65%"> اسم الحساب الرئيس   </th>
            ...
            <form method="post" id="productForm" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">إضافة حساب رئيس  </h4>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $.get("{{ route('main_account.index') }}" +'/' + product_id +'/edit', function (data) {

                    $('#modelheading').html("edit emp type");
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('main_account.store') }}"+'/'+product_id,
