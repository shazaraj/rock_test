        ...
        <section class="content-header">
            ...
            <h6 style="text-align:right;direction: rtl;">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#"> بطاقة مادة أولية</a></li>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="tableData" class="table table-bordered table-striped" dir="rtl">
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%">سعر المبيع</th>
                                        <th width="15%"> قابلية التصنيع و البيع  </th>
            ...
            <form method="post" id="productForm" enctype="multipart/form-data">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="item_price_sale" id="item_price_sale" class="form-control">
                        <br/>
                        <label> إعادة التصنيع و البيع     </label>
                        <select name="refactoring" id="refactoring" class="form-control" >
                            @if(count($refactoring)> 0)
                                @foreach($refactoring as $main_account)
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('#tableData').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('raw_materials.index') }}",
                columns: [
                    ...
                    {data: 'item_price_sale', name: 'item_price_sale'},
                    {data: 'refactoring', name: 'refactoring'},
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $.get("{{ route('raw_materials.index') }}" + '/' + product_id + '/edit', function (data) {
                    ...
                    $('#name').val(data.name);
                    $('#quantity_type').val(data.quantity_type);
                    $('#quantity').val(data.quantity);
                    $('#item_price').val(data.item_price);
                    $('#item_price_sale').val(data.item_price_sale);
                    $('#refactoring').val(data.refactoring_ability);
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('raw_materials.store') }}" + '/' + product_id,
