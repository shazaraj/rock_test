        ...
        <section class="content-header">
            ...
            <h6 style="text-align:right;direction: rtl;">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#"> بطاقة مصاريف سيارة </a></li>
            ...
            <form method="post" id="productForm" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">إضافة مصاريف للسيارة</h4>
                    </div>
                        ...
                        <select name="car_id" id="car_id" class="form-control">
                            @if(count($cars) >0 )
                                @foreach ($cars as $client_type)
                                    <option value="{{$client_type->id}}">{{$client_type->car_type}}</option>
                                @endforeach
                                    @endif
                        </select>
                        <br/>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var table = $('#tableData').DataTable({
                ...
                ajax: "{{ route('cars_maintainances.index') }}",
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $.get("{{ route('cars_maintainances.index') }}" + '/' + product_id + '/edit', function (data) {
            ...
            $('#action').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('cars_maintainances.store') }}",
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('cars_maintainances.store') }}" + '/' + product_id,
